...
const NotificationCard = ({ data, index, notificationState }) => {
    ...
    let { seen, type, createdAt, comment, reply,replied_on_comment, user, user: { personal_info: { profile_img, fullname, username }}, blog: { _id, blog_id, title }, _id: notification_id} = data;
    ...
    <div className={'p-6 border-b border-grey border-l-black ' + ( !seen ? "border-l-2" : "")}>
        <div className='flex gap-5 mb-3'>
            ...
            <div className='w-full'>
                ...
                {
                   replied_on_comment &&  type == "reply"  ?
                    <div className="p-4 mt-4 rounded-md  bg-dark-grey">
                        <div>{replied_on_comment.comment}</div>
                    </div>
                    :
                ...
                <div className='flex gap-3 mb-3'>
                    ...
                    <div>
                        <h1 className='font-medium text-xl text-dark-grey'>
                            ...
                            <span className='font-normal 0'>replied to</span>
