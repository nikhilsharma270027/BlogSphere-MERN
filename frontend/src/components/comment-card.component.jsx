...
const CommentCard = ({ index, leftValue, commentData }) => {
    ...
    const removeCommentsCards = (startingPoint, isDelete = false) => {
      //it will remove data from array
    ...
    const LoadMoreRepliesButton = () => {
      ...
      //showing load more below children comment
  ...
  return (
    <div className='w-ful' style={{  paddingLeft: `${leftValue * 10}px` }}>
        ...
        <div className='my-5 p-6 rounded-md border border-grey'>
            ...
            <div className='flex gap-5 items-center mt-5'>
              ...
              {
                  //only the user can delete the comment ,noone else
                  username == commented_by_username || username == blog_author ?
                  <button className='p-2 px-5 rounded-md border border-grey ml-auto hover:bg-red/30 hover:text-red flex items-center' onClick={deleteComment}>
