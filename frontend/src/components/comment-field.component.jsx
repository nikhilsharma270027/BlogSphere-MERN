...
const CommentField = ({ action, index = undefined, replyingTo = undefined, setReplying }) => {
    //action will be either a comment or reply bothj will have
    //different functionality, instead of creating two different
    // components for two diffent things we do in one
    ...
    const handleComment = () => {
        ...
        .then(({ data }) => {
            ...
            if(replyingTo){
                ...
                // [1, 2, 3] => [2 => 4] => [1, 2, 4, 3]
                //4 is reply ,index will keep track of 
