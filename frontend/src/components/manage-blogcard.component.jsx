...
const BlogStats = ({ stats }) => {
    ...
    return (
        <div className='flex gap-2 max-lg:mb-6 max-lg:pb-6 border-grey broder-b'>
            {
  ...
  return (
    <>
        <div className='flex gap-10 border-b mb-6 max-md:px-4 border-grey pb-6 items-center'>
            <img src={banner} className='max-md:hidden  lg:hidden xl:block w-28 h-28 flex-none bg-grey object-fill' /> 
                                                                                                    {/* object-cover */}
