...
const Notifications = () => {
  ...
  const fetchNotications = ({ page, deletedDocCount = 0}) => {
    ...
    <div>
...

      {
        ...
        <>
          ...
          <LoadMoreDataBtn state={notifications} fetchDataFun={fetchNotications} additionalParam={{ deletedDocCount: notifications.deletedDocCount }}/>
        </>
      }
    </div>
  )
